...
class GameScene: SKScene , SKPhysicsContactDelegate {
    ...
    // Declaration of variables for storing the basic detail of the Game.
    ...
    func createScene(){
        // Method for creating Physics Bodies in the Scene
        ...
        // loop creates 2 instances of Background Node and places them side by side.
        for i in 0..<2
        {
